...
<div class="container">
    ...
    <c:url var="back_to_package_list" value="/user/show-packages"/>
    <a class="btn btn-success" href="${buy_package}">Buy Package</a>
    <a class="btn btn-primary" href="${back_to_package_list}">Back to Package List</a>
</div>
</body>
</html>
